...
public class VarietalFormResultFormatter implements DeductionFormContract, DatabaseContract {

    private SparseIntArray formSelections;
    ...
    public VarietalFormResultFormatter(SparseIntArray formSelections) {
        this.formSelections = formSelections;
    }

    public HashMap<String, Integer> getDescriptorsHashMap() {

        HashMap<String, Integer> convertedData = new HashMap<>();

        for (int i = 0; i < formSelections.size(); i++) {
            int key = formSelections.keyAt(i);
            int value = formSelections.get(key);
