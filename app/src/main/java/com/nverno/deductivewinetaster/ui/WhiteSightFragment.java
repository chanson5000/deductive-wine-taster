...
public class WhiteSightFragment extends Fragment implements DeductionFormContract {

    private WhiteDeductionFormActivity mFragmentActivity;
    private SharedPreferences mSharedPreferences;

    @BindView(R.id.scrollView_sight_white)
    ScrollView mScrollViewSightWhite;

    public WhiteSightFragment() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_sight_white,
                container, false);
    ...
    private void setUiState() {
        ...
        for (Map.Entry<String, ?> entry : allEntries.entrySet()) {
            ...
            if (whiteSightViews.contains(key) && AllRadioGroups.contains(key)) {
