...
public interface RedWineContract {
    ...
    String PALATE_SWEETNESS = "PALATE_SWEETNESS";
    String PALATE_FRUIT_RED = "PALATE_FRUIT_RED";
    String PALATE_FRUIT_BLACK = "PALATE_FRUIT_BLACK";
    String PALATE_FRUIT_BLUE = "PALATE_FRUIT_BLUE";
    String PALATE_FRUIT_CHARACTER_RIPE = "PALATE_FRUIT_CHARACTER_RIPE";
    String PALATE_FRUIT_CHARACTER_FRESH = "PALATE_FRUIT_CHARACTER_FRESH";
    String PALATE_FRUIT_CHARACTER_TART = "PALATE_FRUIT_CHARACTER_TART";
    String PALATE_FRUIT_CHARACTER_BAKED = "PALATE_FRUIT_CHARACTER_BAKED";
    String PALATE_FRUIT_CHARACTER_STEWED = "PALATE_FRUIT_CHARACTER_STEWED";
    String PALATE_FRUIT_CHARACTER_DRIED = "PALATE_FRUIT_CHARACTER_DRIED";
    String PALATE_FRUIT_CHARACTER_DESICATTED = "PALATE_FRUIT_CHARACTER_DESICCATED";
    String PALATE_FRUIT_CHARACTER_BRUISED = "PALATE_FRUIT_CHARACTER_BRUISED";
    String PALATE_FRUIT_CHARACTER_JAMMY = "PALATE_FRUIT_CHARACTER_JAMMY";
    String PALATE_NON_FRUIT_FLORAL = "PALATE_NON_FRUIT_FLORAL";
    String PALATE_NON_FRUIT_VEGETAL = "PALATE_NON_FRUIT_VEGETAL";
    String PALATE_NON_FRUIT_HERBAL = "PALATE_NON_FRUIT_HERBAL";
    String PALATE_NON_FRUIT_SPICE = "PALATE_NON_FRUIT_SPICE";
    String PALATE_NON_FRUIT_ANIMAL = "PALATE_NON_FRUIT_ANIMAL";
    String PALATE_NON_FRUIT_BARN = "PALATE_NON_FRUIT_BARN";
    String PALATE_NON_FRUIT_PETROL = "PALATE_NON_FRUIT_PETROL";
    String PALATE_NON_FRUIT_FERMENTATION = "PALATE_NON_FRUIT_FERMENTATION";
    String PALATE_EARTH_FOREST_FLOOR = "PALATE_EARTH_FOREST_FLOOR";
    String PALATE_EARTH_COMPOST = "PALATE_EARTH_COMPOST";
    String PALATE_EARTH_MUSHROOMS = "PALATE_EARTH_MUSHROOMS";
    String PALATE_EARTH_POTTING_SOIL = "PALATE_EARTH_POTTING_SOIL";
    String PALATE_MINERAL_MINERAL = "PALATE_MINERAL_MINERAL";
    String PALATE_MINERAL_WET_STONE = "PALATE_MINERAL_WET_STONE";
    String PALATE_MINERAL_LIMESTONE = "PALATE_MINERAL_LIMESTONE";
    String PALATE_MINERAL_CHALK = "PALATE_MINERAL_CHALK";
    String PALATE_MINERAL_SLATE = "PALATE_MINERAL_SLATE";
    String PALATE_MINERAL_FLINT = "PALATE_MINERAL_FLINT";
    String PALATE_WOOD = "PALATE_WOOD";
    String PALATE_WOOD_OLD_VS_NEW = "PALATE_WOOD_OLD_VS_NEW";
    String PALATE_WOOD_LARGE_VS_SMALL = "PALATE_WOOD_LARGE_VS_SMALL";
    String PALATE_WOOD_FRENCH_VS_AMERICAN = "PALATE_WOOD_FRENCH_VS_AMERICAN";
